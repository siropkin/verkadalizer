 ...
 */
export async function mergeImages(originalImageUrl, aiImageData) {
  // Backward-compatible wrapper: reference == menu layer.
  return mergeMenuLayerWithBackground(originalImageUrl, originalImageUrl, aiImageData);
}
